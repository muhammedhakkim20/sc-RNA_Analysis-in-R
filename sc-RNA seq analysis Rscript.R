...
# data source: https://www.10xgenomics.com/resources/datasets/10-k-human-pbm-cs-multiome-v-1-0-chromium-controller-1-standard-2-0-0         
 ...
 setwd("D:/RNA Seq raw data/sc-RNA_Seq/demo/")
 
input_path <- "D:/RNA Seq raw data/sc-RNA_Seq/demo/data/"
...
nsclc.sparse.m <- Read10X_h5(paste0(input_path, filename = 'vdj_v1_hs_aggregated_donor3_filtered_feature_bc_matrix.h5'))
str(nsclc.sparse.m)
...
nsclc.seurat.obj
# 19150 features across 52125 samples
